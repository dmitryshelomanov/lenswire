  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-2xl px-5 py-12 sm:py-16">
        ...
        <p className="mt-4 text-lg text-muted">Last updated: 2026-07-30</p>
        ...
        <div className="mt-10 space-y-5 text-lg leading-relaxed text-ink/90">
          ...
          <h2 className="!mt-10 font-display text-3xl tracking-tight">Who we are</h2>
          ...
          <h2 className="!mt-10 font-display text-3xl tracking-tight">Data we process</h2>
          <p>
          ...
          <h3 className="!mt-8 text-xl font-semibold tracking-tight">Network traffic</h3>
          <p>
          ...
          <h3 className="!mt-8 text-xl font-semibold tracking-tight">Certificates</h3>
          <p>
          ...
          <p>
            If you use Copy as cURL, Share HAR, or similar export actions, you choose where that
            data goes (clipboard, share sheet, etc.). Lenswire does not send those exports to us.
          </p>

          <h2 className="!mt-10 font-display text-3xl tracking-tight">Permissions</h2>
          ...
          <h2 className="!mt-10 font-display text-3xl tracking-tight">Children’s privacy</h2>
          <p>
            Lenswire is not directed at children under 13. We do not knowingly collect personal
            information from children.
          </p>

          <h2 className="!mt-10 font-display text-3xl tracking-tight">Changes</h2>
          <p>
          ...
          <h2 className="!mt-10 font-display text-3xl tracking-tight">Contact</h2>
          <p>
